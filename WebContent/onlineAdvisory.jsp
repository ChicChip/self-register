...
<body>
   <!--top-->
    ...
    <div class="Content">
            ...
            <div class="Sidebar">
                           <div class="Menu">
                    <h4>网上咨询<span>Advisory</span></h4>
                    <ul>
                            <li id="menu1"><a href="#">科室咨询</a></li>
                            <li id="menu2"><a href="#">专家咨询</a></li>
                    </ul>
               </div>
                  ...
                  <div class="mianContent">
                           ...
                           <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Advisory_table">
                              <tr>
                                ...
                                <td><input name="" type="text" class="text"/></td>
                              </tr>
                              <tr>
                                <td class="name">性　　别<span>*</span></td>
                                <td><input name="input" type="text" class="text"/></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td><input name="input3" type="text" class="text"/></td>
                              </tr>
                              <tr>
                                <td class="name">地　　址<span>*</span></td>
                                <td><input name="input4" type="text" class="text"/></td>
                              </tr>
                              <tr>
                                <td class="name">邮　　箱</td>
                                <td><input name="input5" type="text" class="text"/></td>
                              </tr>
                              <tr>
                                <td valign="top" class="name">质询内容<span>*</span></td>
                                <td><textarea name="input6" class="text03"></textarea></td>
                              </tr>
                              <tr>
                                <td valign="top" class="name">&nbsp;</td>
                                <td><input name="" type="button" value="确定留言" class="btn01"/> <input name="input7" type="button" value="重置留言" class="btn02"/></td>
                              </tr>
                           </table>
                           <!--End-->
