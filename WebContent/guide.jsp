...
<body>
   <!--top-->
    ...
    <div class="Content">
            ...
            <div class="Sidebar">
                           <div class="Menu">
                    <h4>就医指南<span>Medical guide</span></h4>
                    <ul>
                            <li id="menu1"><a href="#">门急诊就诊流程</a></li>
                            <li id="menu2"><a href="#">住院病人就诊流程</a></li>
                            <li id="menu3"><a href="#">开诊时间表</a></li>
                            <li id="menu4"><a href="#">开诊科目表</a></li>
                            <li id="menu5"><a href="#">专家出诊表</a></li>
                            <li id="menu6"><a href="#">预约挂号</a></li>
                            <li id="menu7"><a href="#">楼层指引</a></li>
                            <li id="menu8"><a href="#">方位指南</a></li>
