...
<body>
    ...
    <center>
        <s:form role="form" action="recommend">
            <s:checkbox name="yourillness" fieldValue="发热" label="发热"/>
            <s:checkbox name="yourillness" fieldValue="肺系疾病" label="肺系疾病"/>
            <s:checkbox name="yourillness" fieldValue="寄生虫病" label="寄生虫病"/>
            <s:checkbox name="yourillness" fieldValue="颅内感染" label="颅内感染"/>
            <s:checkbox name="yourillness" fieldValue="乙肝" label="乙肝"/>
            <s:checkbox name="yourillness" fieldValue="慢性肝炎" label="慢性肝炎"/>
