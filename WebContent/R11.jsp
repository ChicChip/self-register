...
<body>
    ...
    <center>
        <s:form role="form" action="recommend">
            <s:checkbox name="yourillness" fieldValue="抑郁症" label="抑郁症"/>
            <s:checkbox name="yourillness" fieldValue="焦虑症" label="焦虑症"/>
            <s:checkbox name="yourillness" fieldValue="睡眠障碍" label="睡眠障碍"/>
            <s:checkbox name="yourillness" fieldValue="儿童心理问题" label="儿童心理问题"/>
            <s:checkbox name="yourillness" fieldValue="慢性疲劳综合征" label="慢性疲劳综合征"/>
            <s:checkbox name="yourillness" fieldValue="心理康复" label="心理康复"/>
            <s:checkbox name="yourillness" fieldValue="性心理障碍" label="性心理障碍"/>
            <s:checkbox name="yourillness" fieldValue="精神分裂症" label="精神分裂症"/>
            <s:checkbox name="yourillness" fieldValue="酒依赖" label="酒依赖"/>
