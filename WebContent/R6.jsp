   ...
   <!--top-->
    ...
    <center>
        <s:form role="form" action="recommend">
            <s:checkbox name="yourillness" fieldValue="脾胃病" label="脾胃病"/>
            <s:checkbox name="yourillness" fieldValue="月经不调" label="月经不调"/>
            <s:checkbox name="yourillness" fieldValue="老年病" label="老年病"/>
            <s:checkbox name="yourillness" fieldValue="中风后遗症" label="中风后遗症"/>
            <s:checkbox name="yourillness" fieldValue="胃肠病" label="胃肠病"/>
            <s:checkbox name="yourillness" fieldValue="养生保健" label="养生保健"/>
