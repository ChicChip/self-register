...
<body>
    ...
    <center>
        <s:form role="form" action="recommend">
            <s:checkbox name="yourillness" fieldValue="耳聋" label="耳聋"/>
            <s:checkbox name="yourillness" fieldValue="眩晕" label="眩晕"/>
            <s:checkbox name="yourillness" fieldValue="人工耳蜗植入" label="人工耳蜗植入"/>
            <s:checkbox name="yourillness" fieldValue="慢性支气管炎" label="慢性支气管炎"/>
            <s:checkbox name="yourillness" fieldValue="眼部整形" label="眼部整形"/>
            <s:checkbox name="yourillness" fieldValue="眼眶外伤" label="眼眶外伤"/>
