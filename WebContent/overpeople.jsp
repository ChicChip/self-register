...
<center>
<h1>该医生本时段已满，请重新选择！</h1>
<s:property value="overpeople"/><br/>
<a href="dateselect.jsp"><button type="button" class="btn btn-default" onclick="window.history.go(-1)">返回</button></a>
</center>
