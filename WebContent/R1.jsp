...
<body>
    ...
    <center>
        <s:form role="form" action="recommend">
            <s:checkbox name="yourillness" fieldValue="高血压" label="高血压"/>
            <s:checkbox name="yourillness" fieldValue="心律失常" label="心律失常"/>
            <s:checkbox name="yourillness" fieldValue="心力衰竭" label="心力衰竭"/>
            <s:checkbox name="yourillness" fieldValue="心肌梗塞" label="心肌梗塞"/>
            <s:checkbox name="yourillness" fieldValue="神经衰弱" label="神经衰弱"/>
