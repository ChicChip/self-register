...
<body>
    ...
    <center>
        <s:form role="form" action="recommend">
            <s:checkbox name="yourillness" fieldValue="尿失禁" label="尿失禁"/>
            <s:checkbox name="yourillness" fieldValue="不孕不育" label="不孕不育"/>
            <s:checkbox name="yourillness" fieldValue="性功能障碍" label="性功能障碍"/>
            <s:checkbox name="yourillness" fieldValue="生殖器感染" label="生殖器感染"/>
            <s:checkbox name="yourillness" fieldValue="性病" label="性病"/>
            <s:checkbox name="yourillness" fieldValue="膀胱结石" label="膀胱结石"/>
