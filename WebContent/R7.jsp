...
<body>
    ...
    <center>
        <s:form role="form" action="recommend">
            <s:checkbox name="yourillness" fieldValue="肺癌" label="肺癌"/>
            <s:checkbox name="yourillness" fieldValue="肝癌" label="肝癌"/>
            <s:checkbox name="yourillness" fieldValue="胃癌" label="胃癌"/>
            <s:checkbox name="yourillness" fieldValue="肠癌" label="肠癌"/>
            <s:checkbox name="yourillness" fieldValue="乳腺癌" label="乳腺癌"/>
            <s:checkbox name="yourillness" fieldValue="妇科恶性肿瘤" label="妇科恶性肿瘤"/>
