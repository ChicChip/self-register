...
<body>
   <!--top-->
    ...
    <table align ="center">
         ...
         {
             out.print("<td>"+showdate.get(i)+"</td>");
         }
         out.print("</tr>");
         out.print("<tr>"+"<td>上午</td>");
        for(int i =1;i<showdate.size();i+=2)
         {
        	System.out.print(showdate.size());
             out.print("<td align = \"" + "center" + "\"><a href=deleteDate?nickname=" + nickname + "_" + i +"><button class=\"home-subbtn\">取消</button>"+"</td>");
             System.out.println("<td align = \"" + "center" + "\"><a href=deleteDate?nickname=" + nickname + "&deleterank=" + i +"><button class=\"home-subbtn\">取消</button>"+"</td>");
         }
        out.print("</tr>");
