   ...
   <!--top-->
    ...
    <center>
        <s:form role="form" action="recommend">
            <s:checkbox name="yourillness" fieldValue="脑创伤" label="脑创伤"/>
            <s:checkbox name="yourillness" fieldValue="腹腔镜" label="腹腔镜"/>
            <s:checkbox name="yourillness" fieldValue="癫痫" label="癫痫"/>
            <s:checkbox name="yourillness" fieldValue="食管" label="食管"/>
            <s:checkbox name="yourillness" fieldValue="气管" label="气管"/>
