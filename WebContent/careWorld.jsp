    ...
    <div class="Content">
            ...
            <div class="RightSidebar">
                  ...
                  <div class="mianContent">
                           ...
                           <ul class="World_list">
                                  <li>
                                         <div class="pic"><a href="careWorldInfo.html"><img src="images/temp/Pic03.jpg" /></a></div>
                                         <span><a href="careWorldInfo.html">从我院高尔夫专业毕子</a></span>
                                  </li>
                                  <li>
                                         <div class="pic"><a href="#"><img src="images/temp/Pic04.jpg" /></a></div>
                                         <span><a href="#">从我院高尔夫专业毕子</a></span>
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                         <div class="pic"><a href="#"><img src="images/temp/Pic03.jpg" /></a></div>
                                         <span><a href="#">从我院高尔夫专业毕子</a></span>
                                  </li>
                                  <li>
                                         <div class="pic"><a href="#"><img src="images/temp/Pic04.jpg" /></a></div>
						   ...
						   <script type="text/javascript">
                              $(".World_list li").each(function(i,item){
                                  if(Number(i+1) % 3 == 0)
                                  {
                                      $(this).attr("class","End");
                                  }
