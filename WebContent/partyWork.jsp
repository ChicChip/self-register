...
<body>
   <!--top-->
    ...
    <div class="Content">
            ...
            <div class="Sidebar">
                           <div class="Menu">
                    <h4>党群工作<span>Party work</span></h4>
               </div>
            ...
            <div class="RightSidebar">
                  ...
                  <div class="mianContent">
                           ...
                           <div class="News_top">
                                <div class="photo">
                                <ul>
                                      <li><a href="#"><img src="images/temp/Pic07.jpg" /></a></li>
                                      <li><a href="#"><img src="images/temp/Pic06.jpg" /></a></li>
                                </ul>
                                </div>
                                <div class="hd">
                                <ul>
                                ...
                                <script type="text/javascript" language="javascript">jQuery(".News_top").slide({mainCell:".photo ul",autoPlay:true,delayTime:3000});</script>
                                <ul class="listUl">
                                         <li><span>2014-01-02</span><a href="partyWorkInfo.html">医院坐落于广州市黄埔大道西</a></li>
                                         <li><span>2014-01-02</span><a href="partyWorkInfo.html">天河城西南面的广州市第十二人民医院是由</a></li>
                                         <li><span>2014-01-02</span><a href="partyWorkInfo.html">有三十余年历史的广州市职业病防治院发展</a></li>
                                         <li><span>2014-01-02</span><a href="healthInfo.html">为一间三级综合性医院</a></li>
                                         <li><span>2014-01-02</span><a href="healthInfo.html">有三十余年历史的广州市职业病防治院发展</a></li>
                                </ul>
                           </div>
                           <div class="News_list">
                                <ul>
