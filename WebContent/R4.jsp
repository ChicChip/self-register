   ...
   <!--top-->
    ...
    <center>
        <s:form role="form" action="recommend">
            <s:checkbox name="yourillness" fieldValue="反复呼吸道感染" label="反复呼吸道感染"/>
            <s:checkbox name="yourillness" fieldValue="新生儿疾病" label="新生儿疾病"/>
            <s:checkbox name="yourillness" fieldValue="哮喘" label="哮喘"/>
            <s:checkbox name="yourillness" fieldValue="呼吸系统疾病" label="呼吸系统疾病"/>
